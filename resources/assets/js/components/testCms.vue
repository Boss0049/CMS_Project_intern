		...
		<div class="container" id="content">
			...
			<div class="container">
				...
				<div class="form-group"> 
					...
					<!-- endModal -->
					<textarea class="form-control" id="name" v-model="post.title" @change="autosave()"></textarea>
		        ...
		        <div class="row">
		          	<div class="col-md-4">
		            	<div class="form-group">
		              	...
		              	<datetime format="YYYY-MM-DD H:i:s" @change="autosave()" v-model="post.datetime"></datetime>
		            </div>
		        </div>
...
export default {
  ...
  methods:{
    ...
    show() {
          ...
          this.post.edit = this.$cookie.get('lastid');

        axios.get('/lastid/'+this.post.edit+'/edit', {
            "id":this.post.id,
    ...
    autosave(){
        ...
        axios.put('/autosave/'+this.post.edit,{
